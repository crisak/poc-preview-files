  ...
  return (
    <div className="h-screen flex flex-col">
      <div className="p-2 flex gap-2 items-center flex-wrap">
        ...
        {blobUrl && !loading && (
          <SharePrintButton fileUrl={fileUrl} suggestedName="document.pdf" />
        )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4">
            <p className="text-sm text-green-800">
              <strong>Note:</strong> This solution uses the Web Share API to
              natively share files on mobile devices. It provides access to the
              system's share sheet, which typically includes printing options.
              Works best on mobile browsers and PWAs.
            </p>
          </div>
        ...
        <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
          ...
          <ul className="text-green-800 space-y-1">
            <li>• Native mobile experience with system share sheet</li>
            <li>
              • Access to all installed apps (printers, cloud storage, etc.)
            </li>
            <li>• Works consistently across mobile browsers and PWAs</li>
            <li>• No additional libraries required</li>
            <li>• Perfect for mobile-first applications</li>
            <li>• Users can choose their preferred printing app</li>
          </ul>
        </div>
        ...
        <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          <ul className="text-yellow-800 space-y-1">
            <li>• Limited to mobile devices and modern browsers</li>
            <li>• Requires user interaction (can't auto-print)</li>
            <li>• Fallback needed for desktop browsers</li>
            <li>• Dependent on browser's Web Share API support</li>
          </ul>
        </div>
        ...
        <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-blue-800 space-y-1">
            <li>• Mobile PWAs and web apps</li>
            <li>• Apps targeting mobile users primarily</li>
            <li>• When you want to leverage native mobile features</li>
            <li>• Integration with mobile printing workflows</li>
          </ul>
        </div>
      </div>
    </div>
